...
def test_value_counts(index_or_series_obj):
    ...
    result = obj.value_counts().to_frame()
...
def test_value_counts_inferred(index_or_series, using_infer_string):
    ...
    tm.assert_series_equal(s.value_counts().to_frame(), expected)
...
def test_value_counts_bins(index_or_series, using_infer_string):
    ...
    tm.assert_series_equal(s.value_counts().to_frame(), expected, check_index_type=False)
...
def test_value_counts_datetime64(index_or_series, unit):
    ...
    tm.assert_series_equal(s.value_counts().to_frame(), expected_s)
    ...
    result = s.value_counts().to_frame()
...
def test_value_counts_timedelta64(index_or_series, unit):
    ...
    result = td.value_counts().to_frame()
    ...
    result2 = td2.value_counts().to_frame()
...
def test_value_counts_object_inference_deprecated():
    ...
    with tm.assert_produces_warning(FutureWarning, match=msg):
        res = idx.value_counts().to_frame()

    exp = dti.value_counts().to_frame()
