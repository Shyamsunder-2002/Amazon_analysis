...
class TestMerge:
    ...
    def test_merge_overlap(self, left):
        ...
        exp_len = (left["key"].value_counts().to_frame() ** 2).sum()
...
def test_merge_combinations(
    ...
    if how in ["left", "right", "inner"]:
        ...
        if not other_unique:
            other_value_counts = other["key"].value_counts().to_frame()
        ...
        left_counts = left["key"].value_counts().to_frame()
        right_counts = right["key"].value_counts().to_frame()
